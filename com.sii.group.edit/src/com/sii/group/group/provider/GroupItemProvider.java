...
/**
 * This is the item provider adapter for a {@link com.sii.group.group.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GroupPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLogoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_logo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_logo_feature", "_UI_Group_type"),
				 GroupPackage.Literals.GROUP__LOGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GroupPackage.Literals.GROUP__MUSICIENS);
			childrenFeatures.add(GroupPackage.Literals.GROUP__ALBUM);
			childrenFeatures.add(GroupPackage.Literals.GROUP__TOURNEE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GroupPackage.Literals.GROUP__MUSICIENS,
				 GroupFactory.eINSTANCE.createMusiciens()));

		newChildDescriptors.add
			(createChildParameter
				(GroupPackage.Literals.GROUP__ALBUM,
				 GroupFactory.eINSTANCE.createAlbum()));

		newChildDescriptors.add
			(createChildParameter
				(GroupPackage.Literals.GROUP__TOURNEE,
				 GroupFactory.eINSTANCE.createTournee()));
	}
